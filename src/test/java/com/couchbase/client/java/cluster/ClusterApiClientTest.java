...
public class ClusterApiClientTest {
    ...
    public static void init() {
        ...
        apiClient = new ClusterApiClient("username", "password", core, env);
    }

    @Test
    public void testGetWithParamsBuildsFullUrl() throws Exception {
        ClusterApiClient.RestBuilder restCall = apiClient.get("some", "path/")
    ...
    public void testContentTypeChangesHeaders() {
        ClusterApiClient.RestBuilder restCall = apiClient.get("some")
    ...
    @Test
    public void testJsonChangesHeadersAndContentType() {
        ClusterApiClient.RestBuilder restCall = apiClient.get("some")
                .withHeader("Content-Type", "foo");
        assertThat(restCall.headers()).containsEntry("Content-Type", "foo");
        ...
        restCall.json("body");
        assertThat(restCall.headers()).containsEntry("Content-Type", "application/json");
    }

    private void assertRestCall(ClusterApiClient.RestBuilder baseBuilder,
