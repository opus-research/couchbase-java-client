...
public class SelectDslSomokeTest {
    ...
    @Test
    public void test8() {
        Query query = select(x("fname"), x("age"))
            .from("tutorial")
            .where(x("age").gt(x("30")));
    ...
    @Test
    public void test9() {
        Query query = select(x("fname"), x("email"))
            .from("tutorial")
    ...
    @Test
    public void test10() {
        Query query = selectDistinct(x("orderlines[0].productId"))
            .from("orders");
    ...
    @Test
    public void test11() {
        Query query = select(x("fname"), x("children"))
            .from("tutorial")
    ...
    @Test
    public void test13() {
        Query query = select(x("fname"), x("email"), x("children"))
            .from("tutorial")
    ...
    @Test
    public void test15() {
        Query query = select(x("children[0:2]"))
            .from("tutorial")
