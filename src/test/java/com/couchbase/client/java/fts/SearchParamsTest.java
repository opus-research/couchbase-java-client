...
public class SearchParamsTest {
    ...
    public void shouldInjectFacets() {
        SearchParams p = SearchParams.build()
            .addFacets(
                ...
                SearchFacet.date("dr", "datefield", 1, "name", "start", "end"),
                SearchFacet.numeric("nr", "numfield", 99, "name2", 0.0, 99.99)
            );
        JsonObject result = JsonObject.empty();
        p.injectParams(result);
    ...
    public void shouldThrowOnDateRangeWithoutName() {
        verifyException(SearchFacet.date("facet", "field", 1, "rangeName", "", ""), NullPointerException.class)
    ...
    public void shouldThrowOnNumericRangeWithoutName() {
        verifyException(SearchFacet.numeric("facet", "field", 1, "rangeName", 0d, 0d), NullPointerException.class)
    ...
    public void shouldAllowOneNullBoundOnDateRange() {
        SearchFacet.date("facet", "field", 1, "rangeName", "", "")
    ...
    public void shouldAllowOneNullBoundOnNumericRange() {
        SearchFacet.numeric("facet", "field", 1, "rangeName", 0d, 0d)
