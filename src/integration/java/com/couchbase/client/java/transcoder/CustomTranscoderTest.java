...
public class CustomTranscoderTest {
    ...
    public static void connect() throws Exception {
        ...
        // Necessary pending resolution of JCBC-1132 Bucket cache ignores RBAC credentials and custom transcoders
        ctx.bucket().close();
    }
    ...
    @Ignore("Pending resolution of JCBC-1132 Bucket cache ignores RBAC credentials and custom transcoders")
    @Test
