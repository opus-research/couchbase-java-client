...
public interface AsyncBucket {
    ...
    @InterfaceStability.Experimental
    @InterfaceAudience.Public
    <V>Observable<V> mapRemove(String docId, String key, Class<V> valueType);

    @InterfaceStability.Experimental
    @InterfaceAudience.Public
    <V>Observable<V> mapRemove(String docId, String key, Class<V> valueType, MutationOptionBuilder mutationOptionBuilder);
    ...
    @InterfaceStability.Experimental
    @InterfaceAudience.Public
    <E>Observable<Boolean> setRemove(String docId, E element);

    @InterfaceStability.Experimental
    @InterfaceAudience.Public
    <E>Observable<Boolean> setRemove(String docId, E element, MutationOptionBuilder mutationOptionBuilder);
