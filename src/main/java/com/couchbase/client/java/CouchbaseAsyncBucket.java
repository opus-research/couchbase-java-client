...
public class CouchbaseAsyncBucket implements AsyncBucket {
    ...
    public <V> Observable<Boolean> mapAdd(final String docId,
        ...
        return mapSubdocAdd(docId, key, value, mutationOptionBuilder.getCAS(), mutationOptionBuilder.getPersistTo(),
                ...
                Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>>() {
                    ...
                    public Observable<? extends DocumentFragment<Mutation>> call(Throwable throwable) {
                        if (throwable instanceof DocumentAlreadyExistsException) {
                            return mapSubdocAdd(docId, key, value, cas, persistTo, replicateTo, expiry);
                        } else {
                ...
                .onErrorResumeNext(new Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>>() {
                    ...
                    public Observable<? extends DocumentFragment<Mutation>> call(Throwable throwable) {
                        if (throwable instanceof DocumentDoesNotExistException) {
                            return insert(JsonDocument.create(docId, JsonObject.create().put(key, value)))
    ...
    private <E> Observable<DocumentFragment<Mutation>> listSubdocPushLast(final String docId,
        ...
        return mutateIn(docId).arrayAppend("", element, false)
                ...
                .onErrorResumeNext(new Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>>() {
                    ...
                    public Observable<? extends DocumentFragment<Mutation>> call(Throwable throwable) {
                        if (throwable instanceof DocumentDoesNotExistException) {
                            return insert(JsonArrayDocument.create(docId, JsonArray.create().add(element)))
                                    .map(mapFullDocResulttoSubdoc)
    ...
    public <E> Observable<Boolean> setAdd(String docId, E element, MutationOptionBuilder mutationOptionBuilder) {
        ...
        return subdocAddUnique(docId, element, mutationOptionBuilder.getCAS(), mutationOptionBuilder.getPersistTo(),
                mutationOptionBuilder.getReplicateTo(), mutationOptionBuilder.getExpiry())
                .map(mapResult);
    }

    private <E> Observable<DocumentFragment<Mutation>> subdocAddUnique(final String docId,
                                                                       final E element,
                                                                       final long cas,
                                                                       final PersistTo persistTo,
                                                                       final ReplicateTo replicateTo,
        ...
        final Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>> retryIfDocExists = new
                Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>>() {
                    ...
                    public Observable<? extends DocumentFragment<Mutation>> call(Throwable throwable) {
                        if (throwable instanceof DocumentAlreadyExistsException) {
                            return subdocAddUnique(docId, element, cas, persistTo, replicateTo, expiry);
                        } else {
                            return Observable.error(throwable);
                        }
                    }
    ...
    public <E> Observable<Boolean> queueAdd(String docId, E element, MutationOptionBuilder mutationOptionBuilder) {
        return queueSubdocAddLast(docId, element, mutationOptionBuilder.getCAS(), mutationOptionBuilder.getPersistTo(),
                mutationOptionBuilder.getReplicateTo(), mutationOptionBuilder.getExpiry())
                .map(getMapResultFnForSubdocMutationToBoolean());
    }
    ...
    private <E> Observable<DocumentFragment<Mutation>> queueSubdocAddLast(final String docId,
        ...
        final Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>> retryIfDocExists = new
                Func1<Throwable, Observable<? extends DocumentFragment<Mutation>>>() {
                    ...
                    public Observable<? extends DocumentFragment<Mutation>> call(Throwable throwable) {
                        if (throwable instanceof DocumentAlreadyExistsException) {
                            return queueSubdocAddLast(docId, element, cas, persistTo, replicateTo, expiry);
                        } else {
                            return Observable.error(throwable);
                        }
                    }
