...
public abstract class SearchQuery {
    ...
    public static TermQuery term(String term) {
        return term(term, SearchParams.build());
    }

    public static TermQuery term(String term, SearchParams searchParams) {
        return new TermQuery(term, searchParams);
    }

    public static PhraseQuery phrase(String... terms) {
        return phrase(SearchParams.build(), terms);
    }

    public static PhraseQuery phrase(SearchParams searchParams, String... terms) {
        return new PhraseQuery(searchParams, terms);
    }
