...
public class GeoBoundingBoxQuery extends AbstractFtsQuery {
    ...
    private final float topLeftLat;
    private final float topLeftLon;
    private final float bottomRightLat;
    private final float bottomRightLon;
    private String field;

    public GeoBoundingBoxQuery(float topLeftLon, float topLeftLat, float bottomRightLon, float bottomRightLat) {
