...
public class CouchbaseBucket implements Bucket {
    ...
    @Override
    public <V>V mapRemove(String docId, String key, Class<V> valueType){
        return Blocking.blockForSingle(asyncBucket.mapRemove(docId, key, valueType), kvTimeout, TIMEOUT_UNIT);
    }

    @Override
    public <V>V mapRemove(String docId, String key, Class<V> valueType, MutationOptionBuilder mutationOptionBuilder){
        return Blocking.blockForSingle(asyncBucket.mapRemove(docId, key, valueType), kvTimeout, TIMEOUT_UNIT);
    }
    ...
    @Override
    public <E>boolean setRemove(String docId, E element){
        return Blocking.blockForSingle(asyncBucket.setRemove(docId, element), kvTimeout, TIMEOUT_UNIT);
    }

    @Override
    public <E>boolean setRemove(String docId, E element, MutationOptionBuilder mutationOptionBuilder){
