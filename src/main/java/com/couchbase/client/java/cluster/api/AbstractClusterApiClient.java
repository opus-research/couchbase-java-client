...
public abstract class AbstractClusterApiClient<T extends IRestBuilder> {
     ...
     * @return a {@link IRestBuilder} used to further configure the request (either sync or async). Use its
    ...
    /**
     * Create the concrete {@link IRestBuilder builders} returned by concrete implementations.
