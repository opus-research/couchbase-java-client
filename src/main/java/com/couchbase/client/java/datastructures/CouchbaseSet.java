...
public class CouchbaseSet<E> {
	...
	public Observable<Boolean> add(final E element, final MutationOptionBuilder optionBuilder) {
		return Observable.defer(new Func0<Observable<Boolean>>() {
			...
			public Observable<Boolean> call() {
				return subdocAddUnique(element, optionBuilder.cas, optionBuilder.persistTo, optionBuilder.replicateTo, optionBuilder.expiry)
	...
	private Observable<DocumentFragment<Mutation>> subdocAddUnique(final E element, final long cas, final PersistTo persistTo, final ReplicateTo replicateTo, final int expiry) {
